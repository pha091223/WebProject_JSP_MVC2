    ...
    <div class="container">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb">
          ...
          <li>기관소개</li>
          <li><a href="Servlet?command=noticebbs_list">공지사항</a></li>
          <li><a href="Servlet?command=noticebbs_view&no=${no }">${no }</a>
          <li>수정하기</li>
        </ul>
        <br>
      </div>
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        <div class="col-lg-8 col-md-8 col-sm-6">
          ...
          <div id="message"></div>
          <form id="contact-form" name="writeform" class="contact-form" action="Servlet?command=noticebbs_write_modify&no=${no }" 
            ...
            <div class="form-group">
              ...
              <c:choose>
              	 <c:when test="${fname!=null }">
              	 	<input type="text" class="form-control" value="${fname }" readonly="true">
            		<c:if test="${fileform=='jpg' }">
            			<br>
            			<img src="./bbs/upload/${fname }" width=500>
            		</c:if>
            		...
            		<p></p>
            		<a href="Servlet?command=noticebbs_write_modify_file&no=${no }">
            			<button type="button" class="btn btn-large btn-primary" onclick="return deletecheck()">파일 삭제</button>
            		</a>
            	</c:when>
            	<c:when test="${fname==null }">
            ...
            <br>
            <div class="form-send">
              <button type="submit" class="btn btn-large btn-primary" onclick="return writecheck('modify');">수정</button>
              <a href="Servlet?command=noticebbs_view&no=${param.no }"><button type="button" class="btn btn-large btn-primary">취소</button></a>
            </div>
          </form>
        </div>
