      ...
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        ...
        <div id="bbpress-forums">
	              ...
	              <ul class="forum type-forum status-publish hentry loop-item-0 odd bbp-forum-status-open bbp-forum-visibility-publish">
	                ...
	                <li class="bbp-forum-info">
	                  ...
	                  <a class="bbp-forum-title" 
	                  		href="Servlet?command=eventbbs_view&no=${fbList.no}&page=${pageMaker.prev }" title="General">
	                 	 	${fbList.title }</a>
	                </li>
		  ...
		  <c:if test="${sessionScope.nowuser_Id==name }">
	          <div class=" bbsbutton">
	            <a class=" dmbutton" href="javascript:bbs_authority_check('eventbbs', '${sessionScope.nowuser }');">글쓰기</a>
	          </div>
		  </c:if>
        ...
        <div class=" text-center">
          <ul class="pagination">
          	<c:if test="${pageMaker.prev>0 }">
				<li><a href="Servlet?command=eventbbs_list&page=${pageMaker.prev}">«</a></li>
			</c:if>
            <c:forEach begin="${pageMaker.start }" end="${pageMaker.end}" var="idx">
	            <li><a href="Servlet?command=eventbbs_list&page=${idx}">${idx }</a></li>
            </c:forEach>
            <c:if test="${pageMaker.next>0 }">
				<li><a href="Servlet?command=eventbbs_list&page=${pageMaker.next}">»</a></li>
			</c:if>
          </ul>
       </div>
      <!-- end content -->
