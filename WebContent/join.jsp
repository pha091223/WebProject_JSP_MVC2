		...
		<c:when test="${sign=='true' }">
			<script>
	    		if(!alert("회원가입이 완료되었습니다.")){
	    			location.href="Servlet?command=home_list";
	    		}
			</script>
		</c:when>
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        <div class="col-lg-9 col-md-9 col-sm-12">
          ...
          <form id="registerform" method="post" name="registerform" action="Servlet?command=join">
            ...
            <div class="form-group">
              ...
              <input type="button" class="button" value="중복확인" onclick="return idcheck();">
            ...
            <div class="form-group">
              <p>이메일</p>
              <input type="email" class="form-control" placeholder="선택사항" name="email">
              <p>* ex)000@000.000</p>
            </div>
            <br>
            <div class="form-group">
              <input type="submit" class="btn btn-primary" onclick="return joincheck();" value="가입">
            </div>
          </form>
        </div>
        <!-- end register -->
