    ...
    <div class="container">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb">
          ...
          <li>기관소개</li>
          <li><a href="Servlet?command=eventbbs_list">행사</a></li>
          <li><a href="Servlet?command=eventbbs_view&no=${no }">${no }</a>
          <li>수정하기</li>
        </ul>
        <br>
      </div>
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        <div class="col-lg-8 col-md-8 col-sm-6">
          ...
          <div id="message"></div>
          <form id="contact-form" name="writeform" class="contact-form" action="Servlet?command=eventbbs_write_modify&no=${no }" 
            ...
            <div class="form-group">
              ...
              <c:choose>
              	 <c:when test="${fname!=null }">
            		...
            		<p></p>
            		<a href="Servlet?command=eventbbs_write_modify_file&no=${no }">
            ...
            <div class="form-send">
              ...
              <a href="Servlet?command=eventbbs_view&no=${param.no }"><button type="button" class="btn btn-large btn-primary">취소</button></a>
            </div>
          </form>
        </div>
