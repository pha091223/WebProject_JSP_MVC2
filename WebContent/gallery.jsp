    ...
    <div class="container">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb">
          ...
          <li><a href="Servlet?command=freebbs_list">커뮤니티</a></li>
          <li>갤러리</li>
        </ul>
        <br>
      </div>
    ...
    <div class="container clearfix">
      <div class=" col-lg-12 col-md-12 col-sm-12 clearfix">
        ...
        <nav class="portfolio-filter clearfix">
          <ul>
            <li><a href="#" class="dmbutton2" data-filter="*">All</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".mockups">강좌1</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".graphic-design">강좌2</a></li>
            <li><a href="#" class="dmbutton2" data-filter=".web-design">강좌3</a></li>
          </ul>
        </nav>
