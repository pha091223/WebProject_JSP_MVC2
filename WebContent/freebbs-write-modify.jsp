    ...
    <div class="container">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <ul class="breadcrumb">
          ...
          <li>커뮤니티</li>
          <li><a href="Servlet?command=freebbs_list">자유게시판</a></li>
          <li><a href="Servlet?command=freebbs_view&no=${no }">${no }</a>
          <li>수정하기</li>
        </ul>
        <br>
      </div>
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        <div class="col-lg-8 col-md-8 col-sm-6">
          ...
          <div id="message"></div>
          <form id="contact-form" name="writeform" class="contact-form" action="Servlet?command=freebbs_write_modify&no=${no }" 
            ...
            <div class="form-group">
              ...
              <c:choose>
              	 <c:when test="${fname!=null }">
            		...
            		<p></p>
            		<a href="Servlet?command=freebbs_write_modify_file&no=${no }">
