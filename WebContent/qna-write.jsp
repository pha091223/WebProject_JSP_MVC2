          ...
          <div id="nav" class="right">
            <div class="container clearfix">
              <ul id="jetmenu" class="jetmenu blue">
                ...
                <!-- 고객센터 -->
                <li class="active"><a href="Servlet?command=fqa">고객센터</a>
                  <ul class="dropdown">
    ...
    <div class="container clearfix">
      <div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
        <div class="col-lg-8 col-md-8 col-sm-6">
          ...
          <div id="message"></div>
          <form id="contact-form" name="writeform" class="contact-form" action="Servlet?command=qna_write" 
            ...
            <div class="form-send">
              ...
              <a href="javascript:history.back(-1)"><button type="button" class="btn btn-large btn-primary">취소</button></a>
            </div>
          </form>
        </div>
