  ...
  <section class="section1">
    <div class="container clearfix">
      ...
      <div id="comments_wrapper">
	       ...
	       <a href="Servlet?command=noticebbs_modify&no=${one.no}">
	       <input type="button" class="btn btn-primary" value="수정"></a>
	       <a href="Servlet?command=noticebbs_delete&no=${one.no }">
	       <input type="button" class="btn btn-primary" value="삭제" onclick="return deletecheck();"></a>
         </c:if>
          <a href="Servlet?command=noticebbs_list"><input type="button" class="btn btn-primary" value="목록" style="float: right"></a>
        </div>
        <!-- div comments -->
      </div>
      <!-- end content -->
